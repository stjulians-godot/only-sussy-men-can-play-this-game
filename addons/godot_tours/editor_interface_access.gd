...
var add_a_new_scene_button: Button = null
...
var scene_dock_button_add_instance: Button = null
var scene_dock_button_add_script: Button = null
...
func _init() -> void:
	...
	add_a_new_scene_button = main_screen_tabs.get_child(0)
	...
	scene_dock_button_add_instance = scene_dock.get_child(0).get_child(1)
	scene_dock_button_add_script = scene_dock.get_child(0).get_child(3)
